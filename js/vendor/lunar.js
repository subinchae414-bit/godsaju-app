// Vendored from npm "lunar-javascript" v1.7.7 (MIT License, see LICENSE-lunar-javascript.txt).
// https://github.com/6tail/lunar-javascript
// Provides accurate solar/lunar calendar conversion and BaZi(八字/사주) ganzhi
// calculation (solar-term based year/month pillars, JDN based day pillar),
// used by js/sajuCalc.js instead of asking the LLM to compute pillars itself.
