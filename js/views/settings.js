...
export function renderSettings(container) {
  ...
  container.innerHTML = `
    <div class="page">
      ...
      <div class="section-title" style="margin-top:12px;">사주 풀이 남은 젤리 🐾</div>
      <div class="card" style="margin-bottom:4px;">
        ...
        <div class="hint" style="margin:6px 0 14px;">
          사주·궁합·운세 풀이 1건마다 1젤리씩 사용돼요. 같은 PIN을 쓰는 가족·지인과 함께 나눠 써요.
        </div>
      ...
      <div class="card" style="margin-bottom:4px;">
        <div style="font-size:13px;color:var(--text-dim);line-height:1.7;margin-bottom:12px;">
          ...
          같은 PIN을 입력한 다른 기기와 사람 목록·사주/궁합 풀이·남은 젤리가 함께 보여요.
          ${
            configured
              ? ""
      ...
      <div class="card" style="font-size:13px;color:var(--text-dim);line-height:1.7;">
        등록한 프로필과 사주/궁합/운세 풀이 결과, 남은 젤리는 PIN으로 연결된 Supabase 공간에 저장되어,
  ...
  getCredits()
    .then((balance) => {
      creditsEl.textContent = balance === null ? "아직 풀이를 받아본 적이 없어요" : `${balance}젤리`;
    })
    .catch((err) => {
